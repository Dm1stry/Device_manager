#include "lock_command.hpp"
#include <QDebug>

LockCommand::LockCommand(int x, int y, QObject* parent) :
...
QRectF LockCommand::boundingRect() const
{ 
    return QRectF(x_,y_,width_,height_);
}

void LockCommand::paint(QPainter* ppainter, const QStyleOptionGraphicsItem* option, QWidget* widget)
{
    /*
        Отрисовка интервала
    */
